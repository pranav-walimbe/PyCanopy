...
Regenerate with that tool rather than editing by hand. Geometry columns are
decoded inline with ST_GeomFromWKB, so the queries read the WKB parquet directly.
"""

from __future__ import annotations

SEDONA_SQL: dict[str, str] = {
    "q1": """
